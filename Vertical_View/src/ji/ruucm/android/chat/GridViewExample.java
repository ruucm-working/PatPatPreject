	...
	public void onCreate(Bundle savedInstanceState) {
		...
		gridView.setOnItemClickListener(new OnItemClickListener() {
			public void onItemClick(AdapterView<?> parent, View v,
				...
				Log.d("GridViewExample","position : "+position);
				
				Log.d("GridViewExample","uIMEI : "+uIMEI);
				Log.d("GridViewExample","uName : "+uName);
...
//				i.putExtra("regid", deviceIMEI);
       ...
       Log.d("GridViewExample","deviceIMEI");

		
     /*  
       String uIMEI = aController.getUserData(0).getIMEI();
		String uName = aController.getUserData(0).getName();
		
		Log.d("GridViewExample","aController");
		...
		*/
		...
		Log.d("GridViewExample","Intent");
		
		// Registering user on our server					
		// Sending registraiton details to MainActivity
		i.putExtra("name", "nexus");
		
		Log.d("GridViewExample","tra(");
		i.putExtra("imei", "359618041295763");  // Send to
		i.putExtra("sendfrom", deviceIMEI);
//		i.putExtra("regid", deviceIMEI);
		
		Log.d("GridViewExample","putExtra");
		startActivity(i);
