...
public class Setting extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		Log.i("bugfix_UsingStrictMode", "Setting_Readpref");
		...
		spin1.setOnItemSelectedListener(new OnItemSelectedListener() {
			public void onItemSelected(AdapterView<?> parent, View view,
				...
				Toast.makeText(Setting.this,
						adspin1.getItem(position) + "를 선택했지 난.",
	...
	public void mOnClick(View v) {
		...
		case R.id.ok:
			...
			Log.i("bugfix_UsingStrictMode", "Setting_Writepref01");
			...
			ePref.WriteString("level", level);

			ePref.CommitWrite();
			initPref.CommitWrite();

			Log.i("bugfix_UsingStrictMode", "Setting_Writepref01_End");
			...
			if (preinit) {
				...
				Log.i("bugfix_UsingStrictMode", "Setting_Writepref02");
				...
				Log.i("bugfix_UsingStrictMode", "Setting_Writepref02_End");
