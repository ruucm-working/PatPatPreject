...
public class Lv3_1State implements ICoinBlockViewState {
	...
	Sprite flowerSprite = MediaAssets.getInstance().getSprite(R.drawable.test01);
	Sprite evolve = MediaAssets.getInstance().getSprite(R.drawable.test01_sample4);
...
/*
		...
		public void Draw(CoinBlockView viewContext, Bitmap canvas) {
			...
			SpriteHelper.DrawSprite(canvas, evolve, evolve.NextFrame(), SpriteHelper.DrawPosition.BottomCenter,0,
					-(int)(heightModifier2[blockVib%8] * context.getDensity()));
	...
	private class Lv2ClickAnim implements IAnimatable {
		...
		public void Draw(Bitmap canvas) {
			...
			SpriteHelper.DrawSprite(canvas, evolve, evolve.NextFrame(), SpriteHelper.DrawPosition.BottomCenter,0,
					-(int)(heightModifier2[spriteVib%8] * context.getDensity()));

			if (spriteVib < 3)
				spriteVib++;

//			if(animStage > 60)	
//				context.setState(new Lv2WaitState(context));
