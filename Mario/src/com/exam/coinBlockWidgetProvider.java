...
public class coinBlockWidgetProvider extends AppWidgetProvider {
	...
	public void onEnabled(Context context) {
		...
		// Run service
				...
				//swtich for only one time service 
				mPref.Ready();
				oneServiceSwitch = mPref.ReadBoolean("oneServiceSwitch", true);
				
				
				Log.d("oneServiceSwitch","oneServiceSwitch : "+oneServiceSwitch);
			...
			/*	Log.d("coinBlockWidgetProvider","startService intent1  "+intent);
				...
				Log.d("oneServiceSwitch","startService");
				
				mPref.WriteBoolean("oneServiceSwitch", false);
				mPref.CommitWrite();
				mPref.EndReady();
